...
export interface VaultInfoResponse {
    ...
    /**
     * Gas fee to cover onchain transfer. AmountYouReceive = amountYouSent - withdrawGasFee - withdrawBridgeFeeRate * amountYouSend - withdrawBridgeFeeFixed
     * @type {number}
     * @memberof VaultInfoResponse
     */
    withdrawGasFee?: number;
    /**
     * The service fee rate of bridge. AmountYouReceive = amountYouSent - withdrawGasFee - withdrawBridgeFeeRate * amountYouSend - withdrawBridgeFeeFixed
     * @type {string}
     * @memberof VaultInfoResponse
     */
    withdrawBridgeFeeRate?: string;
    /**
     * The service fee fixed amount of bridge. AmountYouReceive = amountYouSent - withdrawGasFee - withdrawBridgeFeeRate * amountYouSend - withdrawBridgeFeeFixed
     * @type {number}
     * @memberof VaultInfoResponse
     */
...
export const OrderApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [targetChain] (optional) filter result by target chain.
         * @param {string} [targetTokenName] (optional) filter result by target token name.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        orderFromChainFromTokenNameAddressFinalizedGet: async (fromChain: string, fromTokenName: string, address: string, targetChain?: string, targetTokenName?: string, options: any = {}): Promise<RequestArgs> => {
            ...
            if (targetTokenName !== undefined) {
                localVarQueryParameter['targetTokenName'] = targetTokenName;
            }
         ...
         * @throws {RequiredError}
         */
        orderFromChainFromTokenNameAddressPendingGet: async (fromChain: string, fromTokenName: string, address: string, targetChain?: string, targetTokenName?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'fromChain' is not null or undefined
            if (fromChain === null || fromChain === undefined) {
...
export const OrderApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async orderFromChainFromTokenNameAddressFinalizedGet(fromChain: string, fromTokenName: string, address: string, targetChain?: string, targetTokenName?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OrderFinalized>>> {
            const localVarAxiosArgs = await OrderApiAxiosParamCreator(configuration).orderFromChainFromTokenNameAddressFinalizedGet(fromChain, fromTokenName, address, targetChain, targetTokenName, options);
         ...
         * @throws {RequiredError}
         */
        async orderFromChainFromTokenNameAddressPendingGet(fromChain: string, fromTokenName: string, address: string, targetChain?: string, targetTokenName?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OrderPending>>> {
            const localVarAxiosArgs = await OrderApiAxiosParamCreator(configuration).orderFromChainFromTokenNameAddressPendingGet(fromChain, fromTokenName, address, targetChain, targetTokenName, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const OrderApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        orderFromChainFromTokenNameAddressFinalizedGet(fromChain: string, fromTokenName: string, address: string, targetChain?: string, targetTokenName?: string, options?: any): AxiosPromise<Array<OrderFinalized>> {
            return OrderApiFp(configuration).orderFromChainFromTokenNameAddressFinalizedGet(fromChain, fromTokenName, address, targetChain, targetTokenName, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get the deposits waiting for request or not processed yet.
         ...
         * @throws {RequiredError}
         */
        orderFromChainFromTokenNameAddressPendingGet(fromChain: string, fromTokenName: string, address: string, targetChain?: string, targetTokenName?: string, options?: any): AxiosPromise<Array<OrderPending>> {
            return OrderApiFp(configuration).orderFromChainFromTokenNameAddressPendingGet(fromChain, fromTokenName, address, targetChain, targetTokenName, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Register a new order to the bridge.
...
export class OrderApi extends BaseAPI {
     ...
     * @memberof OrderApi
     */
    public orderFromChainFromTokenNameAddressFinalizedGet(fromChain: string, fromTokenName: string, address: string, targetChain?: string, targetTokenName?: string, options?: any) {
        return OrderApiFp(this.configuration).orderFromChainFromTokenNameAddressFinalizedGet(fromChain, fromTokenName, address, targetChain, targetTokenName, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrderApi
     */
    public orderFromChainFromTokenNameAddressPendingGet(fromChain: string, fromTokenName: string, address: string, targetChain?: string, targetTokenName?: string, options?: any) {
        return OrderApiFp(this.configuration).orderFromChainFromTokenNameAddressPendingGet(fromChain, fromTokenName, address, targetChain, targetTokenName, options).then((request) => request(this.axios, this.basePath));
    }
